...
router.post('/', protect, requireRole('instructor', 'admin'), upload.single('coverImage'), cc.create);
router.put('/:id', protect, requireRole('instructor', 'admin'), upload.single('coverImage'), cc.update);
...
router.post('/:courseId/lessons', protect, requireRole('instructor', 'admin'), upload.single('file'), lc.create);
