    ...
    <ImportCsvModal
      ...
      helpText={
        <>
          ...
          <br />Seuls <code className="text-xs bg-gray-100 px-1 py-0.5 rounded">nom</code> et <code className="text-xs bg-gray-100 px-1 py-0.5 rounded">email</code> sont obligatoires. Fichier CSV ou Excel (.xlsx).
        </>
      }
