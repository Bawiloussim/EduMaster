  ...
  return (
    <Link to={`/courses/${course._id}`} className="group bg-white rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-all overflow-hidden flex flex-col">
      ...
      <div className="p-4 flex flex-col flex-1">
        <p className="text-xs font-medium text-blue-600 mb-1">{course.subject}</p>
    ...
    <PageWrapper>
      ...
      <div className="relative mb-8">
        ...
        <input
          ...
          className="w-full max-w-md pl-9 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        {(search || classe || serie) && (
